...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        sta = model_zoo.load_url(model_urls['resnet18'])
        del sta['fc.weight']
        del sta['fc.bias']
...
def resnet34(pretrained=False, **kwargs):
    ...
    if pretrained:
        sta = model_zoo.load_url(model_urls['resnet34'])
        del sta['fc.weight']
        del sta['fc.bias']
        model.load_state_dict(sta, strict=False)
    return model
...
def resnet50(pretrained=False,  **kwargs):
    ...
    if pretrained:
        sta = model_zoo.load_url(model_urls['resnet50'])
        del sta['fc.weight']
        del sta['fc.bias']
        model.load_state_dict(sta, strict=False)
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        sta = model_zoo.load_url(model_urls['resnet101'])
        del sta['fc.weight']
        del sta['fc.bias']
        model.load_state_dict(sta, strict=False)
    return model
...
def resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        sta = model_zoo.load_url(model_urls['resnet152'])
        del sta['fc.weight']
        del sta['fc.bias']
        model.load_state_dict(sta, strict=False)
    return model